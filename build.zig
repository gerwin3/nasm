...
pub fn build(b: *std.Build) void {
    ...
    // TODO: Instead of manually going through all of these better just build
    // nasm on linux, macos and windows, then intercept the config.h.in
    // generated by autoheader and put them here.
    exe.addConfigHeader(b.addConfigHeader(.{
        ...
        .HAVE_DECL_STRSEP = 0,
        .HAVE_ENDIAN_H = have(target.result.os.tag == .linux),
        .HAVE_FACCESSAT = 1,
        .HAVE_FCNTL_H = 1,
        .HAVE_FILENO = 1,
        .HAVE_FSEEKO = 1,
        ...
        .HAVE_ISASCII = 1,
        .HAVE_ISCNTRL = 1,
        .HAVE_MACHINE_ENDIAN_H = have(target.result.os.tag == .macos),
        .HAVE_MEMPCPY = 1,
        .HAVE_MEMPSET = null,
